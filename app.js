...
function getTeacherDisplayName() {
    ...
    return (profile.teacherName && profile.teacherName.trim()) ? profile.teacherName.trim() : 'نظام إدارة الدروس';
}
        ...
        for (let i = 0; i < students.length; i += 10) {
            ...
            chunk.forEach(s => {
                ...
                html += '<div class="card">' +
                    ...
                    '<div class="teacher-name">' + (typeof getTeacherDisplayName === 'function' ? getTeacherDisplayName() : 'نظام إدارة الدروس') + '</div>' +
